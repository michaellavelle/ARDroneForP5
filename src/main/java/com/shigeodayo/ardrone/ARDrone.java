/**
 * ARDroneForP5 https://github.com/shigeodayo/ARDroneForP5 Copyright (C) 2013,
 * Shigeo YOSHIDA.
 *
...
public class ARDrone implements ARDroneInterface {
    ...
    // listeners
    private final List<ImageListener> imageListeners = new ArrayList<ImageListener>();
    private final List<AttitudeListener> attitudeListeners = new ArrayList<AttitudeListener>();
    private final List<BatteryListener> batteryListeners = new ArrayList<BatteryListener>();
    private final List<StateListener> stateListeners = new ArrayList<StateListener>();
    private final List<VelocityListener> velocityListeners = new ArrayList<VelocityListener>();
    ...
    public boolean connectNav() {
        ...
        navdataManager.setAttitudeListener(new AttitudeListener() {
            ...
            public void attitudeUpdated(float pitch, float roll, float yaw,
                    int altitude) {
                for (AttitudeListener attitudeListener : attitudeListeners) {
                    attitudeListener
        ...
        navdataManager.setBatteryListener(new BatteryListener() {
            ...
            public void batteryLevelChanged(int percentage) {
                for (BatteryListener batteryListener : batteryListeners) {
        ...
        navdataManager.setVelocityListener(new VelocityListener() {
            ...
            public void velocityChanged(float vx, float vy, float vz) {
                for (VelocityListener velocityListener:velocityListeners){
    ...
    public void addAttitudeUpdateListener(AttitudeListener attitudeListener) {
        this.attitudeListeners.add(attitudeListener);
    }
    ...
    public void addVelocityUpdateListener(VelocityListener velocityListener) {
        this.velocityListeners.add(velocityListener);
    }

    // remove listeners
    public void removeImageUpdateListener(ImageListener imageListener) {
        imageListeners.remove(imageListener);
    }

    public void removeAttitudeUpdateListener(AttitudeListener attitudeListener) {
        attitudeListeners.remove(attitudeListener);
    }

    public void removeBatteryUpdateListener(BatteryListener batteryListener) {
        batteryListeners.remove(batteryListener);
    }

    public void removeStateUpdateListener(StateListener stateListener) {
        stateListeners.remove(stateListener);
    }

    public void removeVelocityUpdateListener(VelocityListener velocityListener) {
        velocityListeners.remove(velocityListener);
    }
